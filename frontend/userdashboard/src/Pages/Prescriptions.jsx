                                                ...
                                                medicines
                                                    ...
                                                    .map(m => (
                                                        <button
                                                            ...
                                                            className="w-full text-left px-4 py-3 hover:bg-brand-primary/10 transition-colors flex items-center justify-between group"
                                                        >
                                                            <div className="flex flex-col">
                                                                <span className="text-sm font-bold text-brand-text-primary">{m.name}</span>
                                                                <span className="text-[10px] opacity-40 uppercase font-black">{m.category}</span>
                                                            </div>
