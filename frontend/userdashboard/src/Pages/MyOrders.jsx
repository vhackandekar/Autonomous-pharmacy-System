    ...
    <div className="p-8 max-w-5xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6 border-b-2 border-brand-primary/10 pb-8">
        ...
        <div className="flex items-center gap-2">
           <Button variant="secondary" size="sm" className="h-10 px-6 font-black text-[10px] uppercase tracking-widest border-2 border-black/5 dark:border-white/10 hover:border-black/10 dark:hover:border-white/20 dark:text-white">
              <Calendar size={14} className="mr-2" />
              Logs
           </Button>
           <Button variant="primary" size="sm" className="h-10 px-6 font-black text-[10px] uppercase tracking-widest shadow-xl shadow-brand-primary/20">
              New Request
           </Button>
        </div>
      </div>
            ...
            >
              <div className="bg-white dark:bg-white/5 rounded-2xl border-2 border-black/5 dark:border-white/10 p-5 flex flex-col md:flex-row items-center gap-6 group-hover:border-brand-primary/30 transition-all duration-300 shadow-sm hover:shadow-2xl hover:shadow-brand-primary/5 relative overflow-hidden">
                ...
                <div className={`absolute left-0 top-0 bottom-0 w-1.5 ${
                  order.status === 'CONFIRMED' ? 'bg-green-500' : 'bg-brand-primary'
                }`} />
